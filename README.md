...
[![Packagist](https://img.shields.io/badge/Packagist-v2.0.136-blue)](https://packagist.org/packages/konfig/snaptrade-php-7-sdk)
...
```json
{
  ...
  "require": {
    "konfig/snaptrade-php-7-sdk": "2.0.136"
  }
}
```
