...
/**
     ...
     */
    public function getOptionStrategyWithHttpInfo($user_id, $user_secret, $account_id, $options_get_option_strategy_request, string $contentType = self::contentTypes['getOptionStrategy'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOptionStrategyAsyncWithHttpInfo($user_id, $user_secret, $account_id, $options_get_option_strategy_request, string $contentType = self::contentTypes['getOptionStrategy'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\StrategyQuotes';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getOptionStrategyRequest($user_id, $user_secret, $account_id, $options_get_option_strategy_request, $contentType);
     ...
     */
    public function getOptionsChainWithHttpInfo($user_id, $user_secret, $account_id, $symbol, string $contentType = self::contentTypes['getOptionsChain'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOptionsChainAsyncWithHttpInfo($user_id, $user_secret, $account_id, $symbol, string $contentType = self::contentTypes['getOptionsChain'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\OptionChainInner[]';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getOptionsChainRequest($user_id, $user_secret, $account_id, $symbol, $contentType);
     ...
     * @return array of \SnapTrade\Model\StrategyQuotes|\SnapTrade\Model\Model500UnexpectedExceptionResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOptionsStrategyQuoteWithHttpInfo($user_id, $user_secret, $account_id, $option_strategy_id, string $contentType = self::contentTypes['getOptionsStrategyQuote'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOptionsStrategyQuoteAsyncWithHttpInfo($user_id, $user_secret, $account_id, $option_strategy_id, string $contentType = self::contentTypes['getOptionsStrategyQuote'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\StrategyQuotes';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getOptionsStrategyQuoteRequest($user_id, $user_secret, $account_id, $option_strategy_id, $contentType);
     ...
     */
    public function placeOptionStrategyWithHttpInfo($user_id, $user_secret, $account_id, $option_strategy_id, $options_place_option_strategy_request, string $contentType = self::contentTypes['placeOptionStrategy'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function placeOptionStrategyAsyncWithHttpInfo($user_id, $user_secret, $account_id, $option_strategy_id, $options_place_option_strategy_request, string $contentType = self::contentTypes['placeOptionStrategy'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\StrategyOrderRecord';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->placeOptionStrategyRequest($user_id, $user_secret, $account_id, $option_strategy_id, $options_place_option_strategy_request, $contentType);
