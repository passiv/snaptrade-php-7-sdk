...
/**
     ...
     */
    public function getOptionQuoteWithHttpInfo($user_id, $user_secret, $symbol, string $contentType = self::contentTypes['getOptionQuote'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOptionQuoteAsyncWithHttpInfo($user_id, $user_secret, $symbol, string $contentType = self::contentTypes['getOptionQuote'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\OptionQuote';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getOptionQuoteRequest($user_id, $user_secret, $symbol, $contentType);
