...
/**
     ...
     */
    public function listUserErrorsWithHttpInfo($user_id, $user_secret, string $contentType = self::contentTypes['listUserErrors'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listUserErrorsAsyncWithHttpInfo($user_id, $user_secret, string $contentType = self::contentTypes['listUserErrors'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\UserErrorLog[]';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->listUserErrorsRequest($user_id, $user_secret, $contentType);
