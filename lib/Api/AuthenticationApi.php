...
/**
     ...
     */
    public function getUserJWTWithHttpInfo($user_id, $user_secret, string $contentType = self::contentTypes['getUserJWT'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserJWTAsyncWithHttpInfo($user_id, $user_secret, string $contentType = self::contentTypes['getUserJWT'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\EncryptedResponse';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getUserJWTRequest($user_id, $user_secret, $contentType);
