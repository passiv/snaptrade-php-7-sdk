...
/**
     ...
     */
    public function getUserAccountOrderDetailV2WithHttpInfo($account_id, $user_id, $user_secret, $account_information_get_user_account_order_detail_request, string $contentType = self::contentTypes['getUserAccountOrderDetailV2'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserAccountOrderDetailV2AsyncWithHttpInfo($account_id, $user_id, $user_secret, $account_information_get_user_account_order_detail_request, string $contentType = self::contentTypes['getUserAccountOrderDetailV2'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\AccountOrderRecordV2';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getUserAccountOrderDetailV2Request($account_id, $user_id, $user_secret, $account_information_get_user_account_order_detail_request, $contentType);
