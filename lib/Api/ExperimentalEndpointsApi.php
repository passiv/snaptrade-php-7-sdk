...
/**
     ...
     */
    public function getAllAccountPositionsWithHttpInfo($user_id, $user_secret, $account_id, $page = null, $page_size = null, string $contentType = self::contentTypes['getAllAccountPositions'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllAccountPositionsAsyncWithHttpInfo($user_id, $user_secret, $account_id, $page = null, $page_size = null, string $contentType = self::contentTypes['getAllAccountPositions'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\AllAccountPositionsResponse';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getAllAccountPositionsRequest($user_id, $user_secret, $account_id, $page, $page_size, $contentType);
