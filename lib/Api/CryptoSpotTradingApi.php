...
/**
     ...
     */
    public function cryptoSpotCancelOrderWithHttpInfo($user_id, $user_secret, $account_id, $trading_crypto_spot_cancel_order_request, string $contentType = self::contentTypes['cryptoSpotCancelOrder'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cryptoSpotCancelOrderAsyncWithHttpInfo($user_id, $user_secret, $account_id, $trading_crypto_spot_cancel_order_request, string $contentType = self::contentTypes['cryptoSpotCancelOrder'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\OrderUpdatedResponse';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->cryptoSpotCancelOrderRequest($user_id, $user_secret, $account_id, $trading_crypto_spot_cancel_order_request, $contentType);
     ...
     * @return array of \SnapTrade\Model\OrderUpdatedResponse|\SnapTrade\Model\Model400FailedRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function cryptoSpotPlaceOrderWithHttpInfo($user_id, $user_secret, $account_id, $trading_crypto_spot_place_order_request, string $contentType = self::contentTypes['cryptoSpotPlaceOrder'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cryptoSpotPlaceOrderAsyncWithHttpInfo($user_id, $user_secret, $account_id, $trading_crypto_spot_place_order_request, string $contentType = self::contentTypes['cryptoSpotPlaceOrder'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\OrderUpdatedResponse';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->cryptoSpotPlaceOrderRequest($user_id, $user_secret, $account_id, $trading_crypto_spot_place_order_request, $contentType);
     ...
     */
    public function cryptoSpotPreviewOrderWithHttpInfo($user_id, $user_secret, $account_id, $trading_crypto_spot_place_order_request, string $contentType = self::contentTypes['cryptoSpotPreviewOrder'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cryptoSpotPreviewOrderAsyncWithHttpInfo($user_id, $user_secret, $account_id, $trading_crypto_spot_place_order_request, string $contentType = self::contentTypes['cryptoSpotPreviewOrder'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\CryptoSpotOrderPreview';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->cryptoSpotPreviewOrderRequest($user_id, $user_secret, $account_id, $trading_crypto_spot_place_order_request, $contentType);
     ...
     */
    public function cryptoSpotQuoteWithHttpInfo($user_id, $user_secret, $account_id, $base, $quote, string $contentType = self::contentTypes['cryptoSpotQuote'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cryptoSpotQuoteAsyncWithHttpInfo($user_id, $user_secret, $account_id, $base, $quote, string $contentType = self::contentTypes['cryptoSpotQuote'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\CryptoSpotQuote';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->cryptoSpotQuoteRequest($user_id, $user_secret, $account_id, $base, $quote, $contentType);
     ...
     */
    public function cryptoSpotSymbolsWithHttpInfo($user_id, $user_secret, $account_id, $base = null, $quote = null, string $contentType = self::contentTypes['cryptoSpotSymbols'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cryptoSpotSymbolsAsyncWithHttpInfo($user_id, $user_secret, $account_id, $base = null, $quote = null, string $contentType = self::contentTypes['cryptoSpotSymbols'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\TradingCryptoSpotSymbols200Response';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->cryptoSpotSymbolsRequest($user_id, $user_secret, $account_id, $base, $quote, $contentType);
