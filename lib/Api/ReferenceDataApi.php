...
/**
     ...
     * @return array of \SnapTrade\Model\UniversalSymbol, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSymbolsByTickerWithHttpInfo($ticker, $symbol_id = null, string $contentType = self::contentTypes['getSymbolsByTicker'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSymbolsByTickerAsyncWithHttpInfo($ticker, $symbol_id = null, string $contentType = self::contentTypes['getSymbolsByTicker'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\UniversalSymbol';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getSymbolsByTickerRequest($ticker, $symbol_id, $contentType);
